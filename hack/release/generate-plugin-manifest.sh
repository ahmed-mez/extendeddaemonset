...
$SED "s/PLACEHOLDER_SHA_DARWIN_ARM/$DARWIN_ARM64/g" $OUTPUT_FOLDER/eds-plugin.yaml
# $SED "s/PLACEHOLDER_SHA_LINUX/$LINUX_AMD64/g" $OUTPUT_FOLDER/eds-plugin.yaml
$SED "s/PLACEHOLDER_SHA_LINUX_ARM/$LINUX_ARM64/g" $OUTPUT_FOLDER/eds-plugin.yaml
